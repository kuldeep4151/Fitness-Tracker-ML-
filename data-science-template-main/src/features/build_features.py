...
fs = 1000/200
#cutoff use to allow frequency to filter data which means higher
# frequency cut off more data and curves will be more smoother
cutoff=1.3
...
#window size use to set the size of how many previous value function will use
#if we set the window size too big it will throw away alot of data
ws = int (1000/200)
for col in predictor_columns:
...
#plot cluster using projection 3D from matplotlib
